...
\begin{minipage}[t]{0.45\textwidth\hspace{0in}}
    ...
    \section{\underline{Work Experience}}
        ...
        \begin{minipage}[t]{3.75in\textwidth\hspace{0in}}
            ...
            \vspace{0.3em}
            \hspace{1em}\textasteriskcentered \, \mdseries\textrm{\textbf{Lead} On-Prem installations for clients and customized deployments for restrictive environments. Prepared installations by simulating client environments. Designed deployment scripts for regular updates and roll-outs.}
