...
and machine learning. I have experience building backend API's, serving machine learning models, and building frontends \par
\end{minipage}
...
\begin{minipage}[t]{0.45\textwidth\hspace{0in}}
    ...
    \section{\underline{Work Experience}}
        ...
        \hspace{1em}\textasteriskcentered \, \mdseries\textrm{I am a funny dude who plays guitar}
