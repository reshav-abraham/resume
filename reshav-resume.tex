...
\begin{minipage}[t][0pt]{\linewidth}
    ...
    \vspace{0.5em}\hspace{0em}\small\textbf{about me} 
        ...
        \end{minipage}
    \end{minipage}
    \begin{minipage}[t]{2in\linewidth\hspace{-5em}}
        ...
        \faGithub\hspace{0.1em} https://github.com/reshav-abraham 

        \faLinkedin\hspace{0.2em} www.linkedin.com/in/reshav-abraham-ab8016a5

        \faHome \, 160 Vroom Street, Apt 46, Jersey City, NJ 07306
    \end{minipage}
...
\begin{minipage}[t]{0.45\textwidth\hspace{0in}}
    ...
    \section{\underline{Work Experience}}
        ...
        \begin{minipage}[t]{3.75in\textwidth\hspace{0in}}
            ...
            \vspace{0.3em}
            {Early Stage Startup Company that specialized in search and retrieval from unstructured text data. It enabled users to perform search qeries on digital data such as pdf/html/text to extract specific information. The product is built in python, swagger api (OpenApi 3.0.0) and served with gunicorn. The frontend was implemented with React and ANTD. It was containerized with Docker and deployed with kubernetes, It is hosted on gcp and azure.}
            ...
            \vspace{0.3em}
            \hspace{1em}\textasteriskcentered \, \mdseries\textrm{Lead on-prem installation for clients and deploying on restrictive environments. Prepared installation by simulating client environment. Customized the deployment to support the client environment. Designed deployment scripts for regular updates and roll-outs.}
...
\end{minipage}
    \begin{minipage}[t]{3.1in\linewidth\hspace{0.78in}}
