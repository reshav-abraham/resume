...
\end{minipage}
    ...
    \subsection{Multi-core Processor System Verilog}
    \vspace{0.3em}
    \hspace{1em}\textasteriskcentered \, \mdseries\textrm{Implemented a synthesizable multi-core processor for processing MIPS assembly language in SystemVerilog.}
\end{minipage}
